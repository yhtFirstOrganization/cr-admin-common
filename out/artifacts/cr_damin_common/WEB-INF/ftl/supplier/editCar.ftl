...
<body>
	<div class="pd-20">
		<form action="" method="post" class="form form-horizontal"
			id="formCar">
			<div id="carId" style="display:none;">${supplierInfo.carId!""}</div>
			<div class="row cl">
				<label class="form-label col-2"><span class="c-red">*</span>客户名称：</label>
				<div class="formControls col-2">
					<input type="text" class="input-text" value="${carInfo.ownerName!""}" placeholder="" id="ownerName" name="ownerName"
				...
				<div class="formControls col-2">
					<input type="text" class="input-text" value="${carInfo.licensePlateNum!""}" placeholder="" id="licensePlateNum" name="licensePlateNum"
			...
			<div class="row cl">
				...
				<div class="formControls col-2">
					<input type="text" class="input-text" value="${carInfo.linker!""}" placeholder="" id="linker" name="linker"
				...
				<div class="formControls col-2">
					<input type="text" class="input-text" value="${carInfo.carType!""}" placeholder="" id="carType" name="carType"
			...
			<div class="row cl">
				...
				<div class="formControls col-2">
					<input type="text" class="input-text" value="${carInfo.linkerMobile!""}" placeholder="" id="linkerMobile" name="linkerMobile"
				...
				<div class="formControls col-2">
					<input type="text" class="input-text" value="${carInfo.carFrameNum!""}" placeholder="" id="carFrameNum" name="carFrameNum"
			...
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" class="input-text" value="${carInfo.ownerAddress!""}" placeholder="" id="ownerAddress" name="ownerAddress"
		...
		$(function() {
			...
			if("${gid}"){
				...
				if("${pid}"){
					...
					$("#s_city").change();
					if("${qxid}"){
						$("#s_county option[value=${qxid}]").attr("selected",true);
			...
			$("#licensePlateNum").bind("change", function(){
				var licensePlateNum = $("#licensePlateNum").val().trim();
				var ajaxurl="/cr-admin/car/checkLicensePlateNum.do?carId=" + $("#carId").text().trim() + "&licensePlateNum=" + $("#licensePlateNum").val().trim() + "&editType=1";
				$(this).attr("ajaxurl", ajaxurl);
			});
			...
			var form = $("#formCar").Validform({
				...
				callback : function(form) {
					var carId = $("#carId").text().trim();// 获取汽车id
					...
					$.ajax({
						type : "post",
						url : "/cr-admin/car/updateCarInfo.do",
						data : {
							carId : carId,
							carType : carType,
