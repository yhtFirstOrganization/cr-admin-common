...
<body>
	<nav class="breadcrumb">
		...
		汽车维修情况统计 <a class="btn btn-success radius r mr-20"
	...
	<div class="pd-5">
		<div class="HuiTab mt-5">
			...
			<div class="panel panel-default">
				<div class="panel-header">汽车维修情况列表</div>
				<div class="panel-body">
					...
					<form action="" method="post" class="form form-horizontal col-12"
						...
						<div class="row cl">
							<label class="form-label col-2" title="实收收入">收入总额：</label>
							<div class="formControls col-2">
								<input type="text" class="input-text" value="" placeholder=""
							...
							<label class="form-label col-2" title="实收收入-配件总成本">净利润：</label>
							<div class="formControls col-2">
								<input type="text" class="input-text" value="" placeholder=""
					...
					<table
						...
						<thead>
							<tr class="text-c">
								...
								<th width="100" id="stockNo">车型</th>
								<th width="50" id="stockDes">车牌号</th>
								<th width="70" id="stockPriceIncome">维修总次数</th>
								<th width="90" id="stockQuantity">库存总成本</th>
								<th width="90" id="stockUnit">实际收入</th>
								<th width="120">操作</th>
							</tr>
						</thead>
						<tbody>
			...
			<script type="text/javascript"
				src="${base}cr-admin/js/statistics/stock/carUseStock.js"></script>
