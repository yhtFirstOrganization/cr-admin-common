...
<html>
<!--头部-->
<@cc.html_head title="修改维修记录和项目信息">
		...
		<div>
			...
			<form action="" method="post" class="form form-horizontal col-12"
				...
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text"
							value="${repairInfo.repairNum!''}" placeholder="" id="repairNum"
							name="repairNum" disabled>
					</div>
					<span class="Validform_checktip col-2"></span> <label
						class="form-label col-2">维修顾问：</label>
					<div class="formControls col-2">
						<input type="text" class="input-text"
							value="${repairInfo.serviceAdviser!''}" placeholder=""
				...
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text"
							value="${repairInfo.repairMan!''}" placeholder="" id="repairMan"
							name="repairMan" datatype="*1-50" errormsg="维修工应在50字以内！"
							ignore="ignore">
					</div>
					<span class="Validform_checktip col-2"></span> <label
					...
					<div class="formControls col-2">
						<input type="text" class="input-text Wdate"
							value="${repairInfo.repairTime?string('yyyy-MM-dd HH:mm:ss')}"
				...
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text"
							value="${repairInfo.repairSum!''}" placeholder=""
					...
					<div class="formControls col-2">
						<input type="text" class="input-text"
							value="${repairInfo.repairActualSum!''}" placeholder=""
				...
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text"
							value="${repairInfo.warrantyStartMiles!0}" placeholder=""
					...
					<div class="formControls col-3 skin-minimal" id="repairPaymentDiv">
						<div class="radio-box">
							<input type="radio" value="0" id="repairPayment"
								name="repairPayment"<#if (repairInfo.repairPayment)??
							&&repairInfo.repairPayment== "0">checked</#if> datatype="*"
							nullmsg="请选择付款方式！"/> <label for="repairPayment">现金</label>
						</div>

						<div class="radio-box">
							<input type="radio" value="1" id="repairPayment"
								name="repairPayment"<#if (repairInfo.repairPayment)??
							&&repairInfo.repairPayment== "1">checked</#if>/> <label
								for="repairPayment">支票</label>
						</div>

						<div class="radio-box">
							<input type="radio" value="2" id="repairPayment"
								name="repairPayment"<#if (repairInfo.repairPayment)??
							&&repairInfo.repairPayment== "2">checked</#if>/> <label
								for="repairPayment">信用卡</label>
						</div>

						<div class="radio-box">
							<input type="radio" value="3" id="repairPayment"
								name="repairPayment"<#if (repairInfo.repairPayment)??
							&&repairInfo.repairPayment== "3">checked</#if>/> <label
								for="repairPayment">其他</label>
						</div>
					</div>
				...
				<div class="row cl">
					<label class="form-label col-4"></label> <span
						class="Validform_checktip col-2"></span> <label
						class="form-label col-2">付款方式备注：</label>
					<div class="formControls col-2">
						<input type="text" class="input-text" value="${repairInfo.otherBz!''}" placeholder=""
					...
					.Validform(
							{
								...
								callback : function(form) {
									...
									var repairId = $("#repairId").val().trim();// 获取维修id
									...
									$
											.ajax({
												type : "post",
												url : "/cr-admin/repair/updateRepairAndItem.do",
												data : {
													conditionPara : JSON
