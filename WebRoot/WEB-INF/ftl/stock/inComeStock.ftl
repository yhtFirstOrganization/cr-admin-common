...
<body>
	<div class="pd-20">
		<form action="" method="post" class="form form-horizontal"
			id="formStock">
			<input type="text" class="input-text" value="${stockInfo.stockId!"
				"}" style="display:none;" id="stockId">
			<div class="row cl">
				<label class="form-label col-2">项目编号：</label>
				<div class="formControls col-2">
					<input type="text" class="input-text" value="${stockInfo.stockNo!"
						"}" placeholder="" id="stockNo" name="stockNo" disabled>
				</div>
				<span class="Validform_checktip col-2"></span> <label
					class="form-label col-2">项目描述：</label>
				<div class="formControls col-2">
					<input type="text" class="input-text" value="${stockInfo.stockDes!"
						"}" placeholder="" id="stockDes" name="stockDes" disabled>
				</div>
			...
			<div class="row cl">
				<label class="form-label col-2">项目价格：</label>
				<div class="formControls col-2">
					<input type="text" class="input-text"
						value="${stockInfo.stockPrice!" "}" placeholder="" id="stockPrice"
						name="stockPrice" disabled>
				</div>
				<span class="Validform_checktip col-2"></span> <label
					class="form-label col-2 ">项目个数：</label>
				<div class="formControls col-2">
					<input type="text" class="input-text"
						value="${stockInfo.stockQuantity!" "}" placeholder=""
						id="stockQuantity" name="stockQuantity" disabled>
				</div>
				<span class="Validform_checktip col-2"></span>
			...
			<div class="row cl">
				<label class="form-label col-2 ">项目单位：</label>
				<div class="formControls col-2">
					<input type="text" class="input-text"
						value="${stockInfo.stockUnit!" "}" placeholder="" id="stockUnit"
						name="stockUnit" disabled>
				</div>
				<span class="Validform_checktip col-2"></span> <label
					class="form-label col-2">安装工时费：</label>
				<div class="formControls col-2">
					<input type="text" class="input-text"
						value="${stockInfo.workHoursCost!" "}" placeholder=""
						id="workHoursCost" name="workHoursCost" disabled>
				</div>
				<span class="Validform_checktip col-2"></span>
			</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-2">
					<span> <select name="makeupCoSe" id="makeupCoSe"
						...
						style="position: absolute;border:1pt solid #e2dfdf;width: 107%;height: 100%;clip: rect(-1px 190px 190px 113px);">
				...
				<div class="formControls col-2">
					<input type="text" class="input-text"
						...
						id="supplierTel" name="supplierTel">
				</div>
				<span class="Validform_checktip col-2"></span>
			</div>
			...
			<div class="row cl">
				<label class="form-label col-2 "><span class="c-red">*</span>新进货个数：</label>
				<div class="formControls col-2">
					<input type="text" class="input-text" value="" placeholder=""
						id="inComeStockQuantity" name="inComeStockQuantity"
						datatype="/^-?[1-9]+(\.\d+)?$|^-?0(\.\d+)?$|^-?[1-9]+[0-9]*(\.\d+)?$/"
						errormsg="进货个数应为数字！" nullmsg="请填写进货个数！">
				</div>
				<span class="Validform_checktip col-2"></span>
